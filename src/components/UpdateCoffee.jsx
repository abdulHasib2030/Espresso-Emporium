...
const UpdateCoffee = () => {
  ...
  const { _id, name, quantity, supplier, taste, category, details, photoUrl } = loadUpdate
        ...
        <div>
            ...
            <div className='max-w-7xl mx-auto my-10'>
                ...
                <div className="bg-[#F4F3F0] p-24 ">
                    ...
                    <div className='mb-10'>
                        <h1 className="text-3xl font-bold text-center font-font-rancho">Update Existing Coffee Details</h1>
                        <p className='font-font-raleway text-center w-11/12 mx-auto'>
                    ...
                    <form action="" className="space-y-4 " onSubmit={handleUpdateCoffee}>
                        ...
                        <div>
                            ...
                            <div className="w-full">
                                ...
                                <input type="text" defaultValue={photoUrl} name="photoUrl" placeholder="Photo url" className="input input-bordered w-full" />
                            </div>
                        </div>
                        <button className="w-full py-1 font-bold text-center bormd:w-1/2 border-black text-xl bg-[#D2B48C] btn text-black">Add Coffee</button>
                    </form>
                </div>
